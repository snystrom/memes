...
sites. The MEME tool, Dreme, discovers short *de-novo* motifs in input
sequences. We begin the analysis by searching for 5 *de-novo* motifs per binding
category and shuffling the input sequences to use as the control set.
...
whether sites have higher accessibility after E93 expression ("Increasing"),
lower accessibility after E93 expression ("Decreasing"), or if the accessibility
does not change ("Static").

To identify motifs associated with Increasing or Decreasing accessibility in
response to E93 expression, we first grab the DNA sequences of the Increasing,
