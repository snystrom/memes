...
However, there are 3 interesting motifs which distinguish orphan and ectopic
...
```
```{r}
meme_db_path <- system.file("extdata/db/fly_factor_survey_id.meme", package = "dremeR")
