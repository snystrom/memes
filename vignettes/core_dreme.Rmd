...
# I set e = 39 because dreme cannot detect high confidence motifs from only 1 sequence.
...
Therefore, a more appropriate control is to use to use the Static sites as
background. 
