...
I get the following error: installation of package 'R.oo' had non-zero exit status
 ...
 - Solution: when installing the package, set `remotes::install_github("snystrom/dremeR", INSTALL_opts = c("--no-html"))`
 - NOTE: all help documents for dremeR will be parsed as plain-text so will lack links or other formatting.
